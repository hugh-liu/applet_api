...
import com.applet.api.util.Base64;
import com.applet.api.util.GetWebProjectRealPathTool;
import com.applet.api.util.RsaUtil;
...
public class WechatAppletConfig {
    ...
    private static String getUserAppletDecrypt(String str) throws Exception{
        ...
        String path = GetWebProjectRealPathTool.getClassPath("encrypt\\userAppletInfo\\rsa_private_key_pkcs8.pem");
