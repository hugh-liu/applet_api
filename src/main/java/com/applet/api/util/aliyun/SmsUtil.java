package com.applet.api.util.aliyun;
...
public class SmsUtil {
     ...
     * @param singName 短信内容开头【文字内容】
     * @param templeteCode  短信全文内容 数据维护在（bus_sms_template）中
     * @param templateParam
     * @return
    ...
    public static SendSmsResponse sendSms(String mobile, String singName, String templeteCode, String templateParam) throws ClientException {
        ...
        logger.info("发送结果：{}", JSONObject.toJSON(sendSmsResponse).toString());
